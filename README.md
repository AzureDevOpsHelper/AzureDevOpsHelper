...
- Retrieve the groups the current user is a member of (both Entra and Azure DevOps).
 ...
 - Retrieve entitlement info from org with the user info
 ...
 - todo: Create output file with verbose details [Output to a File with full details](https://github.com/AzureDevOpsHelper/AzureDevOpsHelper/issues/2)
## Prerequisites
